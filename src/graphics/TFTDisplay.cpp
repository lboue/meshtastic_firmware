...
#elif !defined(RAK14014) && !defined(M5STACK) && !defined(M5STACK_CORES3) && !defined(UNPHONE)
        tft->wakeup();
        tft->powerSaveOff();
#endif
...
#endif
#ifdef RAK14014
#elif !defined(M5STACK) && !defined(ST7789_CS) && !defined(M5STACK_CORES3) // T-Deck gets brightness set in Screen.cpp in the handleSetOn function
...
#if defined(M5STACK) || defined(M5STACK_CORES3)
    tft->setRotation(0);
#elif defined(RAK14014)
    tft->setRotation(1);
